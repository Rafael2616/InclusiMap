...
sealed interface LoginEvent {
    ...
    data class SetIsPasswordChanged(
        val isChanged: Boolean,
    ) : LoginEvent

    data class DeleteAccount(
        val keepContributions: Boolean,
    ) : LoginEvent
    ...
    data class OnAddEditUserProfilePicture(
        val image: ImageBitmap,
    ) : LoginEvent

    data object OnRemoveUserProfilePicture : LoginEvent

    data class OnAllowPictureOptedIn(
        val value: Boolean,
    ) : LoginEvent
