...
sealed interface PlaceDetailsEvent {
    data class OnUploadPlaceImages(val imagesContent: List<ByteArray>, val placeId: String, val userEmail: String) : PlaceDetailsEvent
    data class OnDeletePlaceImage(val image: PlaceImage) : PlaceDetailsEvent
    data object OnDestroyPlaceDetails : PlaceDetailsEvent
    data class SetCurrentPlace(val place: AccessibleLocalMarker, val userEmail: String) : PlaceDetailsEvent
    data class SetUserAccessibilityRate(val rate: Int) : PlaceDetailsEvent
    data class OnSendComment(val comment: String, val userEmail: String, val userName: String) : PlaceDetailsEvent
    data class OnDeleteComment(val userEmail: String) : PlaceDetailsEvent
    ...
    data class OnUpdatePlaceAccessibilityResources(val resources: List<Resource>, val userEmail: String) : PlaceDetailsEvent
