...
class ContributionsViewModel(
                            ...
                            userFiles
                                ...
                                ?.also { contributionsFile ->
                                    val userContributionsString =
                                        driveService
                                            .getFileContent(contributionsFile.id)
                                            ?.decodeToString()
                                    ...
                                    if (!_state.value.allCommentsContributionsLoaded ||
                                        state.value.userContributions.comments.size != commentsContributions.size
                                    ) {
                                        loadCommentContributions(commentsContributions)
                                    }

                                    if (!_state.value.allPlacesContributionsLoaded ||
                                        state.value.userContributions.places.size != placesContributions.size
                                    ) {
                                        loadPlaceContributions(placesContributions)
                                    }

                                    if (!_state.value.allImagesContributionsLoaded ||
                                        state.value.userContributions.images.size != imageContributions.size
                                    ) {
                                    ...
                                    if (!_state.value.allResourcesContributionsLoaded ||
                                        state.value.userContributions.resources.size != resourcesContributions.size
                                    ) {
            ...
            .launch(Dispatchers.IO) {
                ...
                contributions.chunked(batchSize).forEach { batch ->
                    val deferreds =
                        batch.map { contribution ->
                            async {
                                if (contribution.fileId in inProgressFileIds ||
                                    contribution.fileId in
                                    state.value.userContributions.images
                                        .map { it.placeImage.name }
                                ) {
                                ...
                                try {
                                    ...
                                    driveService.getFileContent(contribution.fileId)?.let { content ->
                                        ...
                                        _state.update {
                                            it.copy(
                                                userContributions =
                                                it.userContributions.copy(
                                                    images =
                                                    it.userContributions.images +
                                                        PlaceImageWithPlace(
                                                            placeImage =
                                                            PlaceImage(
                ...
                _state.update {
                    it.copy(
                        ...
                        it.userContributions.copy(
                            images =
                            it.userContributions.images.filter { imagesWithFileId ->
    ...
    private fun loadCommentContributions(contributions: List<Contribution>) {
            ...
            .launch(Dispatchers.IO) {
                ...
                contributions
                    .map { contribution ->
                        async {
                            driveService
                                .getFileContent(contribution.fileId)
                                ?.also { content ->
                                    val place =
                                    ...
                                    val userComment =
                                        place.comments
                                            .filterNot {
                                                it in
                                                    state.value.userContributions.comments
                                                        .map { it.comment }
                ...
                _state.update {
                    it.copy(
                        ...
                        it.userContributions.copy(
                            comments =
                            it.userContributions.comments.filter { commentsWithFileId ->
    ...
    private fun loadResourcesContributions(contributions: List<Contribution>) {
            ...
            .launch(Dispatchers.IO) {
                                ...
                                ?.also { content ->
                                    ...
                                    _state.update {
                                        it.copy(
                                            ...
                                            it.userContributions.copy(
                                                resources =
                                                it.userContributions.resources +
                ...
                _state.update {
                    it.copy(
                        ...
                        it.userContributions.copy(
                            resources =
                            it.userContributions.resources.filter { resourcesWithFileId ->
    ...
    private fun loadPlaceContributions(contributions: List<Contribution>) {
            ...
            .launch(Dispatchers.IO) {
                            ...
                            try {
                                driveService
                                    ...
                                    ?.also { content ->
                                        ...
                                        if (place.id in
                                            state.value.userContributions.places
                                                .map { it.place.id }
                                        ) {
                                            return@async
                                        }
                ...
                _state.update {
                    it.copy(
                        ...
                        it.userContributions.copy(
                            places =
                            it.userContributions.places.filter { placeWithFileId ->
